	...
	for C in C_values:
		for kernel in kernel_values:
			...
			if legacy: 
				...
				print("Gamma: ",str(gamma), " C=",str(C)," Kernel=",str(kernel))
...
#best_kernel = kernel_values[best_index]
#print("The best gamma parameters are: Gamma=",str(best_gamma),"\t","C=",str(best_C),"\t","Kernel=",str(best_kernel))
# Train over the full training set with the best gamma
clf = SVC(C=100, kernel='rbf', gamma=0.05)
